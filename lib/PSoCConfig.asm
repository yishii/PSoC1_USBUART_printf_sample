...
export LoadConfig_usb_uart_um
export _LoadConfig_usb_uart_um
...
;---------------------------------------------------------------------------
; Load Configuration usb_uart_um
;
;    Load configuration registers for usb_uart_um.
...
;               CUR_PP
;
_LoadConfig_usb_uart_um:
 LoadConfig_usb_uart_um:
    RAM_PROLOGUE RAM_USE_CLASS_4
    lcall   LoadConfigTBL_usb_uart_um            ; Call load config table routine
